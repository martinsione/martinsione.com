...
summary: Reduce your Next.js app in half by replacing react with preact on build time
date: 2022-04-09
---

Hopefully by the end of this post you should have reduced your app size. Note that this isn't for everybody, your app may use advanced react features which are not compatible with preact, if you want to learn more about please [read this](https://preactjs.com/guide/v10/differences-to-react/).
